...
/// A class that contains all theme configurations for the civic-tech application.
class AppTheme {
  AppTheme._();

  // Municipal Trust Palette - Civic-tech color system
  static const Color primaryLight = Color(0xFF1565C0); // Deep civic blue
  static const Color primaryVariantLight = Color(0xFF0D47A1);
  static const Color secondaryLight = Color(0xFF2E7D32); // Community green
  static const Color secondaryVariantLight = Color(0xFF1B5E20);
  static const Color accentLight =
      Color(0xFFF57C00); // Warm orange for urgent actions
  static const Color backgroundLight = Color(0xFFFAFAFA); // Soft off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFC62828); // Clear red
  static const Color warningLight =
      Color(0xFFF9A825); // Amber for moderate priority
  ...
  // Dark theme colors - maintaining civic trust in dark mode
  ...
  // Shadow colors - subtle material elevation
  ...
  /// Light theme - optimized for outdoor mobile use
  static ThemeData lightTheme = ThemeData(
    ...
    chipTheme: ChipThemeData(
      backgroundColor: dividerLight.withValues(alpha: 0.1),
  ...
  /// Dark theme - maintaining civic trust in low-light conditions
  ...
  /// Using Inter font family for optimal mobile readability
